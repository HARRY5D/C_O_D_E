...
def reject_if_suspicious(value: str, context: str) -> Union[Tuple[Response, int], None]:
...
@app.route("/search")
def search() -> Union[Response, str, Tuple[Response, int]]:
...
def update_email() -> Union[Response, Tuple[Response, int]]:
