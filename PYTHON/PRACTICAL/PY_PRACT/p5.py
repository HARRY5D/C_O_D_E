#===== POLYMORPHISM AND ENCAPSULATION DEMONSTRATION =====

# Shape class hierarchy for polymorphism demonstration
class Shape:
...
print(f"add(5): {Calculator.add(5)}")
print(f"add(5, 3): {Calculator.add(5, 3)}")
print(f"add(5, 3, 2): {Calculator.add(5, 3, 2)}")

print("\nCLASS AND STATIC METHODS ")

print(f"Default Pi: {MathOperations.pi}")
MathOperations.change_pi(3.14159)  
print(f"Updated Pi: {MathOperations.pi}")

print(f"Is 7 prime? {MathOperations.is_prime(7)}")
print(f"Is 10 prime? {MathOperations.is_prime(10)}")
...
temp.celsius = 30
print(f"After setting celsius=30: {temp.celsius}°C, {temp.fahrenheit}°F")

temp.fahrenheit = 68
print(f"After setting fahrenheit=68: {temp.celsius}°C, {temp.fahrenheit}°F")

temp.celsius = 400  
print("Temperature set successfully")

base_shape = Shape("Generic")
print(f"Base shape area: {base_shape.calculate_area()}")  
